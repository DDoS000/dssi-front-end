...
export default function CustomiseTheme() {
    ...
    return (
        <div className={`hp-theme-customise ${active && 'active'}`}>
            <div className="hp-theme-customise-button" onClick={() => setActive(!active)}>
            ...
            <div className="hp-theme-customise-container hp-bg-black-0 hp-bg-dark-90">
                <div className="hp-theme-customise-container-header hp-bg-black-10 hp-bg-dark-85 hp-py-16 hp-px-24">
                    <Row justify="space-between">
                        <Col>
                            <span className="h5 hp-d-block hp-text-color-black-80 hp-text-color-dark-0">Customise web</span>
                ...
                <div className="hp-theme-customise-container-body hp-pb-md-96 hp-py-24 hp-px-24">
                    <Row className="hp-theme-customise-container-body-item">
                        <Col span={24} className="hp-mb-16">
                            <span className="hp-d-block hp-caption hp-text-color-black-60 hp-font-weight-bold">THEME</span>
                            <span className="hp-d-block h5 hp-text-color-black-100 hp-text-color-dark-0 hp-font-weight-bold">Dark & Light</span>
                        </Col>
                    ...
                    <Row className="hp-theme-customise-container-body-item" hidden>
                        <Col span={24} className="hp-mb-16">
                            <span className="hp-d-block hp-caption hp-text-color-black-60 hp-font-weight-bold">LAYOUT DIRECTION</span>
                            <span className="hp-d-block h5 hp-text-color-black-100 hp-text-color-dark-0 hp-font-weight-bold">LTR & RTL</span>
                        </Col>
                    ...
                    <Row className="hp-theme-customise-container-body-item" hidden>
                        <Col span={24} className="hp-mb-16">
                            <span className="hp-d-block hp-caption hp-text-color-black-60 hp-font-weight-bold">CONTENT WIDTH</span>
                            <span className="hp-d-block h5 hp-text-color-black-100 hp-text-color-dark-0 hp-font-weight-bold">Full Width & Boxed</span>
                        </Col>
                    ...
                    <Row className="hp-theme-customise-container-body-item" hidden>
                        <Col span={24} className="hp-mb-16">
                            <span className="hp-d-block hp-caption hp-text-color-black-60 hp-font-weight-bold">NAVIGATION STYLE</span>
                            <span className="hp-d-block h5 hp-text-color-black-100 hp-text-color-dark-0 hp-font-weight-bold">Vertical & Horizontal</span>
                        </Col>
