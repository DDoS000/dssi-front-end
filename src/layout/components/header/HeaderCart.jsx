...
export default function HeaderCart() {
  ...
  return (
    <Col className="hp-d-flex-center hp-mr-4 hp-basket-dropdown-button">
      <Button
        type="text"
        icon={<Buy set="curved" className="hp-text-color-black-60" />}
      />
                      ...
                      <Row wrap={false}>
                        ...
                        <Col flex="0 0 110px" className="hp-ml-10">
                          <Link
                            ...
                            onClick={() => dispatch(loadCurrentItem(value))}
                          >
                            <h5 className="hp-mb-0 hp-font-weight-500 hp-p1-body hp-text-color-black-100 hp-text-color-dark-15">
                              {value.title}
                            </h5>

                            <p
                              className="hp-mb-0 hp-caption hp-text-color-black-60"
                              style={{ marginTop: 1 }}
                            >
                              By{" "}
                        ...
                        <Col
                          flex="0 0 80px"
                          className="hp-d-flex hp-d-flex-column hp-ml-8"
                        >
                          <InputNumber
                            min={1}
                            max={99}
              ...
              <Col span={12}>
                <Link to="/apps/ecommerce/checkout" onClick={handleClick}>
                  <Button
                    block
                    type="text"
                    className="hp-text-color-primary-1 hp-text-color-dark-primary-2 hp-hover-bg-primary-4"
                  >
                    View Cart
                  </Button>
                </Link>
